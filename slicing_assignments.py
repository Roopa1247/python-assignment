...
"""
l3 = [1, 2, 3]
print("indexing:",l3[1]) # for indexing the value get in the form of integer
print("slicing:",l3[1:2:]) # for slicing the value get in the form of list
